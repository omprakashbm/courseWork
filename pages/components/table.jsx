    ...
    <div className="items-start justify-between md:flex">
      <div className="max-w-lg">
        <h3 className=" text-xl font-bold sm:text-2xl">
          <span className={style.button}>Supply Chain</span>
        </h3>
      ...
      <div className="mt-3 shadow-sm border rounded-lg overflow-x-auto mt-20">
        <table className="w-fill table-auto text-sm  text-left">
          <thead className="bg-gray-50 text-gray-600 font-medium border-b">
            <tr>
              ...
              <th className="py-3 px-6">Delevery Date</th>
              <th className="py-3 px-6">Prodect Name</th>
